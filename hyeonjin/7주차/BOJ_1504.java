...
public class BOJ_1504 {
	...
	public static void main(String[] args) throws Exception {
		...
		if (cost1 == -1 && cost2 == -1) System.out.println(-1);
		else if (cost1 == -1) System.out.println(cost2);
		else if (cost2 == -1) System.out.println(cost1);
		else System.out.println(Math.min(cost1, cost2));
